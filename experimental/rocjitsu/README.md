...
```bash
# Set MRISA to the directory containing the AMD ISA XML specs
export MRISA=/path/to/mrisa

# Regenerate decoders/encoders for a single ISA
PYTHONPATH=$PWD/lib/python python3 -m amdisa --gen-all \
